...
Для энтузиастов из DEB собран RPM ([проект *.prj(https://github.com/AKotov-dev/DPN-client/blob/main/DPN.prj) для [RPMCreator](https://github.com/AKotov-dev/RPMCreator) см. в репе).
